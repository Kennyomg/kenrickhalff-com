...
I was also working on writing a 3d game engine with aid of a book called Game Engine Architecture and a YouTube series by TheCherno. During the interview I was able to show Protect The Bees. We walked through my code and I was able to explain what my thought process was and what I would've done differently in hindsight. I also showed what I had so far with my game engine. Which made them curious about how I'm learning to make it. I told them about the book and series which I saw was included in their curriculem in a later year.
...
Some interviews went good and some less. I noticed that when the interview was with a tech lead, the interview goes especially well since I'm able to show and discuss code. After weighing my options between 2 companies, I settled with Comsys.

Comsys is a telecom solution. I worked on the dashboard which was made was Angular 1 and made the live chat widget fully responsive

- ### Social Brothers
WordPress, Frontend

At Social Brother I made many custom WordPress themes. I worked on debuut.nl (acquired by RCE) and many of their restaurants. I made a touch screen game JBL that stood in stores. Landing pages for marketing campaigns and optimizing already existing websites.

- ### Casual Development and self-development

After leaving Social Brothers I needed deep introspection on what to do with my life. 

- I always wanted to make games.
- I want to help myself and others
- I want to provide for my family

I decided that I wanted to make apps that can help people in their everyday life. These apps need to be fun and need to actually work. This is how Casual Development was born.
...
Books and YouTube as resources and a clear vision of what I want to achieve, made it possible to make the <a href="https://nextjs-blog-kennyomg.vercel.app/">Casual Happiness</a> app (As of writing the app is best functional on PC and is not yet finished).
...
Professional:
- The little Productivity Tips for dummies
- The little Lean for dummies
- The little ZZP (1 person business) for dummies
- The little Promoting your website for dummies
- The little SEO for dummies
- The little Google Ads for dummies
...
1 common trend I've learned is, that it's all about people and putting yourself in others their shoes. It's about understanding people better and learning how to communicate and listen.
