...
Kenrick Halff<br/>
Media, Application and Game Developer

Born November 5th 1993<br/>
Living in Hilversum, Netherlands

## Core

<p>
  <b>Mission</b>&nbsp;<small>Learn, create, help</small>
  <br/>
  Write code to create a better world by solving real problems
</p>

<p>
  <b>Skills</b>&nbsp;<small>Continuous learning</small>
  <br/>
  React, NextJs, Angular1, ES6, TypeScript, C#, C++, Python
</p>

<p>
  <b>Experience</b>&nbsp;<small>and memories</small>
  <br/>
  6 years professional web development
</p>

<p>
  <b>Values</b>&nbsp;<small>that drive me</small>
  <br/>
  Teamwork, self-sufficiency, self-reliance, truth & empathy
</p>
...
Some interviews went good and some less. I noticed that when the interview was with a tech lead, the interview goes especially well since I'm able to show and discuss code. After weighing my options between 2 companies, I choose Comsys mainly because I like working long on a product better.

<p><Link href="/blog/comsys"><a>Comsys</a></Link> is a telecom solution. I worked on the dashboard (which was made in Angular 1) and made the live chat widget fully responsive.</p>

- ### HU (Hogeschool Utrecht)
Technical informatics

I was still curious if a higher education was for me after NHTV. Being interested in robotics, I tried out technical informatics. I enjoyed my first year, but having already experience in software development, it was a complete repeat. Even though in the later years things would've gotten more interesting. I also noticed that the traditional teaching method isn't well suited for me compared to self motivated study in terms of learning speed.

I did like helping classmates and learned a bunch about business (since the first 2 semesters included all tech students including business IT). I really liked the teachers and it was loads of fun going to meetups.

- ### Social Brothers
WordPress, Frontend

At <Link href="/blog/social-brothers"><a>Social Brothers</a></Link> I made many custom WordPress themes. I worked on debuut.nl (acquired by RCE) and many of their restaurants. I made a touch screen game JBL that stood in stores. Projects varied a lot, from e-commerce to NGO's. From building them to migration and maintenance. 

My WordPress and Frontend skills considerably improved over the course of working here. I also learned about Copywriting, Digital Marketing, Web Design and SEO. Some projects pushed me in terms of speed and accuracy. Like building a webshop in 1 week. I do understand why people might like this approach to software developement, but I prefer quality over quantity in my craftmanship.
...
At the moment I'm looking for work because my girlfriend and I want to rent a place together. Casual Happiness is almost done. When it's done it takes time for it to grow and evolve till the app has enough revenue to sustain itself. Therefore having an income and gaining experience with working at a company that aligns with my value would be a good next step.
...
My name is Kenrick Halff. I'm a 29 year old guy from the Netherlands. Thank you for reading!
